/**
 * @preserve jQuery Text Overflow v0.7.2
 *
                ...
                return this.each(function () {
                    ...
                    if (clone.width() > originalWidth) {
                        while (low < high) {
							...
							clone.empty().append(domSplit(originalElement.get(0), mid)).append(o.str);
                            if (clone.width() < originalWidth) {
                                low = mid + 1;
                            } else {
                                high = mid;
                        ...
                        if (low < originalText.length) {
							element.empty().append(domSplit(originalElement.get(0), low - 1)).append(o.str);
                        }
                    }
                    clone.remove();
